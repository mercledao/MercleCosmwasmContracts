...
xiond init $MONIKER --chain-id $CHAIN_ID --home $HOME
...
xiond genesis add-genesis-account $MY_VALIDATOR_ADDRESS 10000000stake --home $HOME
...
xiond genesis add-genesis-account $MY_ACC1_ADDRESS 1000000000stake --home $HOME
...
# Create a gentx.
xiond genesis gentx validator1 10000000stake --chain-id $CHAIN_ID --keyring-backend test --home $HOME
